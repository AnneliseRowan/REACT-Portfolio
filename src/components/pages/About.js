                    ...
                    <div className="col-md-6 col-md-push-1 animate-box">
                        <div className="about-desc">
                            ...
                            <div className="desc">
                                ...
                                <p className="col-12" style={{marginLeft: "50px"}}>Apart from being a software engineer, I enjoy a game of Samurai Sudoku every night. I love traveling, meeting new people, and experiences that challenge me. I have ridden an elephant, touched a rhino, pet a lion, and sat on a crocodile. I can handle anything you throw at me!

When forced indoors, I watch Chopped and try to imagine what I would do with the basket of ingredients. I enjoy hosting game nights and having people over. You can always find me with a cup of Irish breakfast tea that is constantly needing to be rewarmed.</p>
